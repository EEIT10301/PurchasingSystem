				...
				<div class="lr">
					<div class="form-group mb-2">
						<label for="Inv_id" class="col-md-4">請款單單號</label> <input
							type="text" class="form-control col-md-5 mb-2" name="Inv_id"
				...
				<div class="dlr">
					...
					<div class="form-group mb-2">
						<label for="Recript_date" class="col-md-3">修改憑證日期</label> <input
							type="date" class="form-control col-md-4 mb-2"
							name="Recript_date" id="ttt" value=""> <input name="xxzs"
							type="hidden" value="${oldRecript_date}">
					...
					<div class="form-group  mb-2">
						<label class="col-md-3" for="Receiptpic">修改憑證圖檔</label> <input
							id="input-b5" name="Receiptpic" type="file">
					</div>
				...
				<div class="lr">
					<div class="form-group mb-2">
						<label for="Inv_id" class="col-md-5">請款單單號</label> <input
							type="text" class="form-control col-md-5 mb-2" name="Inv_id"
							id="" readonly="readonly" value="${invid}">
					</div>
					<div class="form-group mb-2">
						<label for="Emp_id" class="col-md-5">申請人</label> <input
							type="text" class="form-control col-md-5 mb-2" name="Emp_id"
							id="" readonly="readonly" value="${empid}">
					</div>
					<div class="form-group mb-2">
				...
				<div class="dlr">
					<div class="form-group  mb-2">
						<label for="Recript_date" class="col-md-4">憑證日期</label> <input
							type="text" class="form-control col-md-3 mb-2"
							name="Recript_date" id="" readonly="readonly" value="${keyday}">
					...
					<c:if test="${not empty sug}">
						<div class="form-group mb-2">
							...
							<table class="text-center table table-hover col-md-8 mb-2">
								<thead>
									<tr>
										<th>流程順序</th>
										<th>簽核人</th>
